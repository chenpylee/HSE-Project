...
public class AddRecordActivity extends Activity {
    ...
    private void saveRecord(){
        ...
        RecordInfo recordInfo=new RecordInfo(record_task_id,record_organ_id,record_description,imageList,record_contact, record_phone,record_created, record_updated);
        recordInfo.saveToDB();
        recordSaved=true;
        quitActivity();
    }
