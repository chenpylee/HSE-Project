...
public class SafetyDBTabActivity extends Activity implements ActionBar.TabListener,OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("选择检查内容");
        //actionBar.setNavigationMode(ActionBar.NAVIGATION_MODE_LIST);


        //SpinnerAdapter mSpinnerAdapter = ArrayAdapter.createFromResource(getActionBar().getThemedContext(), R.array.self_check_action_list, android.R.layout.simple_spinner_dropdown_item);
    ...
    class DropDownListenser implements ActionBar.OnNavigationListener {
        ...
        String[] listNames = getResources().getStringArray(R.array.self_check_action_list);
        @Override
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case 0:
                    return getString(R.string.title_safety_section1).toUpperCase(l);
                case 1:
                    return getString(R.string.title_safety_section2).toUpperCase(l);
            }
            return null;
        }
    }
