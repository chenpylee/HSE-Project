...
public class SelfCheckFinalActivity extends Activity implements ActionBar.TabListener,OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("自纠自查");

        ApplicationController.saveCurrentTaskAndOrganID("0","990");//taskID=0 自纠自查 taskID=-1 历史记录
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if(response.has(ApplicationConstants.JSON_RESULT))
                    {
                        ...
                        {
                            String msg=response.optString("message");
                            Toast.makeText(SelfCheckFinalActivity.this, msg, Toast.LENGTH_SHORT).show();
