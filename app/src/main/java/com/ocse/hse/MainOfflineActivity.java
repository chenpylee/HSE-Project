...
public class MainOfflineActivity extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuInflater.inflate(R.menu.main_offline, menu);
    ...
    private void getTaskListFromServer()
    {
                ...
                try {
                    ...
                    if(response.has(ApplicationConstants.JSON_RESULT))
                    {
                        ...
                        else if(result==-1)
                        {
                            ...
                            JcrwInfo.clearJcrwInDB();
                            Toast.makeText(MainOfflineActivity.this, msg, Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        Response.ErrorListener errorListener= new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(MainOfflineActivity.this,"连接服务器失败",Toast.LENGTH_SHORT).show();
            }
        };
    ...
    {
        Intent intent=new Intent(this,TabOfflineActivity.class);
