...
public class CertificateInfoAdapter extends BaseAdapter {
    ...
    public CertificateInfoAdapter(String groupTitle,Activity activity, ArrayList<String> input) {
        mContext = activity;
        this.activity=activity;
        this.organ_id=organ_id;
        dataArrayList=new ArrayList<String>();
        dataArrayList.add(groupTitle);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String title=dataArrayList.get(position);
