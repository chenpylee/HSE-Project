 ...
 */
public class SelfServiceQueryAdapter extends BaseAdapter {
    private Activity activity;
    private LayoutInflater mInflater;
    private TypedArray serviceIconData;
    private String[] serviceNameData;
    private String[] serviceDescriptionData;
    public SelfServiceQueryAdapter(Activity activity)
    {
        this.activity=activity;
        mInflater=LayoutInflater.from(this.activity);
        serviceIconData = activity.getResources().obtainTypedArray(R.array.self_check_icon_array);
        serviceNameData=activity.getResources().getStringArray(R.array.self_check_array);
        serviceDescriptionData=activity.getResources().getStringArray(R.array.self_check_description_array);
    }
    @Override
    public int getCount() {
